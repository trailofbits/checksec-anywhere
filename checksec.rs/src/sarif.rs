...
use crate::{
    binary::{BinSpecificProperties, Binary},
    elf, macho, pe,
    shared::{Rpath, VecRpath},
};
use serde_json;
...
/// # Errors
///
/// This function returns an error when `serde_json` fails to serialize the sarif structure to json
/// # Returns
///
/// Returns a `serde_json::Result<String>` containing the formatted SARIF JSON string on success.
pub fn get_sarif_report(results: &[Binary]) -> serde_json::Result<String> {
    ...
    let sarif_runs: Vec<sarif::Run> = results
        ...
        .map(|result| {
            let results: Vec<sarif::Result> = result
                .blobs
                .iter()
                .flat_map(|blob| match &blob.properties {
                    ...
                    BinSpecificProperties::Error(_) => unreachable!(
...
fn get_file_artifact(filename: &Path) -> sarif::Artifact {
...
fn get_tool_spec() -> sarif::Tool {
    sarif::Tool::builder()
        .driver(
            sarif::ToolComponent::builder().name("checksec-anywhere").build(),
        )
        .build()
}

// Wrap a vector of runs into a full sarif report and convert it to json
fn build_sarif_for_checksec(
    runs: Vec<sarif::Run>,
...
fn create_elf_results(
    elf_result: &elf::CheckSecResults,
) -> Vec<sarif::Result> {
    vec![
        ...
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Clang SafeStack enabled: {}",
                        elf_result.clang_safestack
                    ))
                    .build(),
            )
        ...
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Stack Clash Protection enabled: {}",
                        elf_result.stack_clash_protection
                    ))
                    .build(),
            )
        ...
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Fortify: {}",
                        elf_result.fortify.to_string().trim_end()
                    ))
                    .build(),
            )
            .level(match elf_result.fortify {
                ...
                elf::Fortify::Partial | elf::Fortify::None => {
                    sarif::ResultLevel::Warning
                }
            })
            .build(),
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Number of fortified functions: {}",
                        elf_result.fortified.to_string().trim_end()
                    ))
                    .build(),
            )
            .level(match elf_result.fortify {
        ...
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Number of fortifiable functions: {}",
                        elf_result.fortifiable.to_string().trim_end()
                    ))
                    .build(),
            )
            .level(match elf_result.fortify {
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        ...
                        elf_result.nx.to_string().trim_end()
                    ))
                    .build(),
            )
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        ...
                        elf_result.pie.to_string().trim_end()
                    ))
                    .build(),
            )
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        ...
                        elf_result.relro.to_string().trim_end()
                    ))
                    .build(),
            )
            .level(match elf_result.relro {
                elf::Relro::Partial | elf::Relro::None => {
                    sarif::ResultLevel::Warning
                }
        ...
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Runtime search path (overrrides rpath): {}",
                        elf_result.runpath
                    ))
                    .build(),
            )
        ...
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Symbol count: {}",
                        elf_result.symbol_count.to_string().trim_end()
                    ))
                    .build(),
            )
            .level(sarif::ResultLevel::Note)
        ...
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Executable code seperate from ELF header data: {}",
                        elf_result.seperate_code
                    ))
                    .build(),
            )
            .level(if elf_result.seperate_code {
                sarif::ResultLevel::None
            } else {
                sarif::ResultLevel::Warning
            })
    ...
    vec![
        ...
        sarif::Result::builder()
            ...
            .level(match pe_result.aslr {
                pe::ASLR::DynamicBase | pe::ASLR::None => {
                    sarif::ResultLevel::Warning
                }
        ...
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Safe Structured Exception Handler: {}",
                        pe_result.safeseh
                    ))
                    .build(),
            )
        ...
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Control-flow enforcement technology compatible: {}",
                        pe_result.cet
                    ))
                    .build(),
            )
        ...
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Symbol count: {}",
                        pe_result.symbol_count.to_string().trim_end()
                    ))
                    .build(),
            )
            .level(sarif::ResultLevel::Note)
...
#[allow(clippy::too_many_lines)]
fn create_macho_results(
    macho_result: &macho::CheckSecResults,
) -> Vec<sarif::Result> {
    vec![
        sarif::Result::builder()
            .rule_id("architecture".to_string())
        ...
        sarif::Result::builder()
            ...
            .message(
                sarif::Message::builder()
                    .text(format!(
                        "Symbol count: {}",
                        macho_result.symbol_count.to_string().trim_end()
                    ))
                    .build(),
            )
            .level(sarif::ResultLevel::Note)
